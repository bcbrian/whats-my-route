...
export default class App extends Component {
  ...
  renderHeader() {
    return (
      <nav className="navbar bg-faded navbar-dark bg-wmr">
        <Link className="navbar-brand" to={'/'}>
          <svg width="50px" height="50px" viewBox="0 0 962 684" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" style={{fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: 1.41421 }}>
        ...
        {/* <span style={{"textAlignment":"center"}}> */}
        {/* <li className="nav-item active"> */}
        <a target="_blank" className="nav-link far-right" href="https://goo.gl/forms/J0vvH9Stld4BkwDq1">
          &nbsp; Help improve the app with feed back
        </a>
        {/* </li> */}
